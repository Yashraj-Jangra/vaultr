    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--fg)]">
      ...
      <div className="border-b border-[var(--border)] bg-neutral-950">
        <div className="max-w-6xl mx-auto px-6 py-12 relative flex items-center justify-between gap-8">
          <div>
            <p className="text-[11px] text-neutral-600 uppercase tracking-widest mb-3">Under the hood</p>
            <h1 className="text-[32px] font-semibold text-neutral-100 tracking-tight mb-2">Security Architecture</h1>
            <p className="text-[14px] text-neutral-500 max-w-md">How _vaultr keeps your credentials private — even from us.</p>
          </div>
