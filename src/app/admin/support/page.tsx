  ...
  if (selectedTicket) {
    return (
      <div className="p-8 pb-20 h-[calc(100vh-4rem)] flex flex-col">
        <div className="flex flex-col flex-1 text-[var(--fg)] min-h-0">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[var(--border)] pb-6 mb-6 gap-4 shrink-0">
        ...
        <div className="flex-1 border border-[var(--border)] bg-[var(--surface)] rounded-xl overflow-hidden flex flex-col relative shadow-sm min-h-0">
                ...
                return (
                  <div key={msg.id} className={`flex ${isAdmin ? "justify-end" : "justify-start"}`}>
                    <div className={`max-w-[70%] px-5 py-3 rounded-2xl shadow-sm ${
                      ...
                      <div className={`text-[11px] mt-2 flex items-center justify-between ${isAdmin ? "text-[var(--bg)] opacity-70" : "text-[var(--fg-muted)]"}`}>
            ...
            <form onSubmit={handleSendReply} className="flex flex-col gap-3">
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="bg-[var(--accent)] text-[var(--bg)] px-6 py-2 rounded-lg font-medium hover:opacity-90 disabled:opacity-50 transition-all flex items-center gap-2"
                >
