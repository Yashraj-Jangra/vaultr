...
const RELEASES: Release[] = [
  ...
  },
  {
    ...
    changes: [
      ...
      { type: "mobile", text: "Upgraded Android adaptive app icon to official safe-zone standards for crisp display across all launchers." },
      { type: "mobile", text: "Refined Master Password unlock screen with responsive keyboard layout and aligned fingerprint sensor." },
      { type: "mobile", text: "Polished 2FA camera QR scanner with a smooth, clean rounded scan overlay." },
      { type: "mobile", text: "Optimized 2FA login assignment modal with website favicons and smooth scrolling." },
      { type: "mobile", text: "Redesigned Settings and Account screens with segregated storage and profile cards." },
      { type: "feature", text: "Standardized circular action buttons across vault list and 2FA generator." },
    ],
  },
  {
    version: "v0.2.4",
