    ...
    <div className="min-h-screen bg-[var(--bg)] text-[var(--fg)]">
      ...
      <div className="border-b border-[var(--border)] bg-neutral-950">
        <div className="max-w-6xl mx-auto px-6 py-12 flex items-center justify-between gap-8">
          <div>
            <p className="text-[11px] font-mono text-neutral-500 uppercase tracking-widest mb-3">Legal & Compliance</p>
            <h1 className="text-[32px] font-bold text-neutral-100 tracking-tight mb-2">Privacy Policy</h1>
